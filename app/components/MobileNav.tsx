export default function MobileNav() {
  return <div className="mobile-nav">
    ...
    <details>
      ...
      <nav aria-label="Navegação móvel"><a href="/">Início</a><a href="/historia">História</a><a href="/territorio">Território</a><a href="/comunidade">Comunidade</a><a href="/acervo">Acervo</a></nav>
    </details>
  </div>;
}
