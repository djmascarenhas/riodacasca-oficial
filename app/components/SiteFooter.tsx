...
export default function SiteFooter() {
  return (
    <footer>
      ...
      <div className="footer-links"><Link href="/historia">História</Link><Link href="/atrativos">Atrativos</Link><Link href="/comunidade">Comunidade</Link><Link href="/acervo">Acervo</Link><Link href="/guimaraes">Guimarães</Link><Link href="/contribua">Contribua</Link></div>
