...
export default function Territorio() {
  return (
    <main>
      ...
      <section className="care"><div><p className="section-index">03 — Visita responsável</p><h2>O melhor caminho deixa apenas lembranças.</h2></div><div className="care-list"><p><span>01</span> Confirme acesso, clima e condições da estrada antes de sair.</p><p><span>02</span> Respeite propriedades, moradores e áreas de proteção ambiental.</p><p><span>03</span> Não deixe resíduos e evite qualquer ação com risco de incêndio.</p><p><span>04</span> Em rios e cachoeiras, observe correnteza e mudanças repentinas no tempo.</p></div></section>
