...
const places = [
  { number: "01", title: "Cachoeira do Casca / Martinha", text: "Uma sequência de cinco quedas e um poço natural. O complexo está interditado por decisão judicial desde abril de 2025 e não recebe visitantes.", detail: "Águas e formações rochosas", href: "https://www.chapadadosguimaraes.mt.gov.br/Turismo/Atrativos-Turistico/39/" },
  { number: "02", title: "Cachoeira da Pedra Furada", text: "Localizada na comunidade do Rio da Casca, combina uma curta trilha de terra, relevo marcado e uma queda procurada para banho e contemplação.", detail: "Paisagem e caminhada", href: "https://www.chapadadosguimaraes.mt.gov.br/Turismo/Atrativos-Turistico/40/" },
  { number: "03", title: "Estação Ecológica", text: "Criada em 1994, reúne dois perímetros e aproximadamente 3.534 hectares destinados à proteção da natureza e à pesquisa científica.", detail: "Conservação e pesquisa", href: "https://www.chapadadosguimaraes.mt.gov.br/fotos_documentos_downloads/6067.pdf" },
];

export default function Territorio() {
  return <main>
    <SiteHeader active="atrativos" />
    <section className="territory-hero"><div className="territory-hero-copy"><p className="eyebrow">Natureza e território · Chapada dos Guimarães</p><h1>Água que desenha<br/><em>a paisagem.</em></h1><p>O Rio da Casca atravessa um território de cerrado, rochas, quedas d&apos;água e comunidades. Conhecê-lo também significa compreender seus limites e ajudar a preservá-lo.</p></div><div className="territory-photo"><img src="/atrativos/ponte-rio-da-casca.jpg" alt="Ponte sobre o Rio da Casca cercada pela vegetação"/><span>Ponte do Casca · Acervo Rio da Casca</span></div></section>
